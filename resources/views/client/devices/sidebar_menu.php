   ...
   <div class=" rsidebar span_1_of_left">
                <div class="of-left">
                    <h3 class="cate"><?php echo $type; ?> Categorieën</h3>
                </div>
                <ul class="menu">
                <?php 
    ...
    ?>
            ...
            <div class="product-middle">
                ...
                <div class="fit-top">
                    ...
                    <a href="tel:<?php echo $telNr ?>" class="shop-now">BEL NU</a>
...
<br />
            ...
            <div class="product-bottom">
                ...
                <div class="product-go">
                    <div class=" fashion-grid">
                        <a href="#"><img class="img-responsive " src="images/repair/aan-uit.png" alt=""></a>
