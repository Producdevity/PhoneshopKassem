          ...
          @foreach ($devices as $device)
              <div class="col-sm-4 bottom-cd simpleCart_shelfItem">
                <div class="product-at">
                  <a href="{{ url('/toestellen/'. $device->id) }}">
                    <img class="img-responsive productImage" src="{{ asset('images/devices/').'/'.$device->img }}" alt="">
                  </a>
                </div>
                <p class="tun"></p>
                <a href="{{ url('/toestellen/'. $device->id) }}" class="item_add">
                  <p class="number item_price">{{$device->name}}</p>
                </a>
              </div>
          @endforeach
          {{-- </div> --}}
